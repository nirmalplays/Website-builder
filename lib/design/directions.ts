...
export const DIRECTIONS: Direction[] = [
  ...
  },
  {
    ...
    fonts: { display: "Inter Tight", body: "Inter Tight", mono: "JetBrains Mono" },
    type: {
      ...
      body: `${f("Inter Tight", "sans-serif")} text-base leading-[1.55] text-[#111111]`,
      lead: `${f("Inter Tight", "sans-serif")} text-2xl md:text-[28px] leading-[1.2] tracking-tight font-[500]`,
  ...
  },
  {
    ...
    type: {
      ...
      body: `${f("Space Grotesk", "sans-serif")} text-[15px] leading-relaxed text-[#8E959F]`,
      lead: `${f("Space Grotesk", "sans-serif")} text-lg md:text-xl leading-relaxed text-[#8E959F]`,
  ...
  },
  {
    ...
    type: {
      ...
      body: `${f("Archivo", "sans-serif")} text-base leading-relaxed text-[#141517]`,
      lead: `${f("Archivo", "sans-serif")} text-xl leading-snug font-[500] text-[#55595F]`,
