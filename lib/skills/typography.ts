...
export const FONTS: Family[] = [
  ...
  { name: "Playfair Display", role: "display", weights: [400, 700, 900], note: "high-contrast serif; editorial, luxury" },
  { name: "Fraunces", role: "display", weights: [400, 700, 900], note: "soft wonky serif; warm, crafted, artisanal" },
  { name: "Instrument Serif", role: "display", weights: [400], note: "tight elegant serif; modern editorial" },
  { name: "DM Serif Display", role: "display", weights: [400], note: "clean didone; confident, expensive" },
  { name: "Bodoni Moda", role: "display", weights: [400, 700, 900], note: "extreme contrast didone; fashion, gallery" },
  { name: "Libre Baskerville", role: "display", weights: [400, 700], note: "bookish serif; trustworthy, literary" },
  { name: "Syne", role: "display", weights: [400, 700, 800], note: "eccentric wide grotesque; art, culture, odd" },
  { name: "Unbounded", role: "display", weights: [400, 700, 900], note: "geometric display; bold, technical, loud" },
  ...
  { name: "Outfit", role: "body", weights: [400, 500, 700], note: "even geometric sans; modern, neutral-plus" },
  ...
  { name: "IBM Plex Mono", role: "mono", weights: [400, 500], note: "warmer mono; labels, captions" },
